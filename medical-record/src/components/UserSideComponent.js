            ...
            <div className="container-fluid profile-body">
                <div className="row">
                    <div className="col-lg-2 col-sm-4 col-12 order-3 order-sm-1" id="pSec1">
                        <div id="leftPanel">
                            <div className={path==='/user/profile'?'lists active-list':'lists'}>
								<a href="/user/profile">Profile</a>
								<img src={defaultDp} className="Icons Icons-invert"/>
							</div>
                            <div className={path==='/user/disease'?'lists active-list dropdown' : 'lists dropdown'}>
                                <a href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="false">
									Diseases
								</a>
                                <img src={diseaseImage} className="Icons"/>
                                <div id="myDropdown" className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <a  className="dropdown-item" onclick='{}'>Add New</a>
                                </div> 
                            </div>
                            ...
                            <div className="hospital-list">
                                ...
                                <div id="mySidenavTab" className="sidenav">
                                    <div id="Dr">
										...
										<a className="closebtn" onClick={()=>{closeNavTab()}}><i	className="fa fa-angle-left sideNav " aria-hidden="true"></i></a>
                                    
									</div>
                                    <form id="hospital-search" className="sidenav-form">
                                        <input type="text" placeholder="Search..." className="mobile-preview shadow floating-animate" name="hnam" id="id_search"/>
										<button id="id_search_button">click</button>
                                    </form>
                                </div>
                                <div id="Drs">
                                <button className={path==='/user/userHospital'?'sideNavButton lists active-list' : 'sideNavButton lists'}>
                                    <a>Hospitals</a>
                                    <img src={doctorIcon} className="Icons Icons-invert" onclick={''}/>
                                </button>
                                </div>
                                </div>
                            </div>
