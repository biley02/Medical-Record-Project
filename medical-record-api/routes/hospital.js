...
router.post("/nominee", requireAuth, hospitalController.mail_to_nominee);
router.get("/login", hospitalController.login_get);
router.get("/verify/:id", hospitalController.emailVerify_get);
router.get("/logout", hospitalController.logout_get);
...
router.post(
  "/profile/editDetails",
  requireAuth,
  hospitalController.editDetails_post
);

router.get("/profile", requireAuth, hospitalController.profile_get);

router.post("/patient", requireAuth, hospitalController.patient_post);
